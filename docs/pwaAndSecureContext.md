...
- Host your own hugging face FRP server fork in a cloud. Read here for details https://github.com/huggingface/frp and `.env.example` for settings. In this case the tunnel will be permanent and controlled by you. You can also set an additional HTTP Authentication for better projection
