...
**Accent color hue, saturation, lightness**: The default is Dusty Cobalt. Vibrant Mandarin - the closest to Gradio's default. Normal Cobalt - closest to Gradio's blue. Dark Mandarin = brown; Pastel Fuchsia = pink. For gray colors hue doesn't have effect
