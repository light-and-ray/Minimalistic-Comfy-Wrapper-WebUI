...
**Accent color hue, saturation, lightness**: The default is Dusty Blue. Vibrant Mandarin - the closest to Gradio's default. Normal Blue - closest to Gradio's blue. Dark Mandarin = brown; Pastel Fuchsia = pink. For gray colors hue doesn't have effect
