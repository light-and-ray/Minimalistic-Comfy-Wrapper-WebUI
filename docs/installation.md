...
- (Only for not same server standalone setup) If you use HTTPS connection, you need to set `COMFY_TLS` variable inside .env file (need to create in extension root)
