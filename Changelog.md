...
- Add copy button in text prompts, shown only when not empty and inside secure context
...
- Added "Fullscreen" button in the footer, or **Alt/Ctrl**+**F** or **F11** hotkey
- Added option "Hold Escape button to exit UI fullscreen"
...
- Remove item on click in presets batch
