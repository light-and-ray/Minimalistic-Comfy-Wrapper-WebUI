...
_REQUESTS_TIMEOUT_NORMAL_SEC = os.getenv("REQUESTS_TIMEOUT_NORMAL_SEC", 30)
_REQUESTS_TIMEOUT_BIG_SEC = os.getenv("REQUESTS_TIMEOUT_BIG_SEC", _REQUESTS_TIMEOUT_NORMAL_SEC*4)
REQUESTS_TIMEOUT_NORMAL = (_REQUESTS_TIMEOUT_NORMAL_SEC, _REQUESTS_TIMEOUT_NORMAL_SEC)
REQUESTS_TIMEOUT_BIG = (_REQUESTS_TIMEOUT_BIG_SEC, _REQUESTS_TIMEOUT_BIG_SEC)
if MCWW_AUTH:
...
MCWW_THEME_FLAGS = ["Bold", "Borderless", "Rounded", "Thick scrollbars"]
