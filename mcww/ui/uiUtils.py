...
def getIfaceCustomHead():
    ...
    ifaceCustomHead = (
        ...
        '<meta name="viewport" content="width=device-width, initial-scale=1, interactive-widget=resizes-content, viewport-fit=cover">' # for floated run button reacting on virtual keyboard
        "<script>"
