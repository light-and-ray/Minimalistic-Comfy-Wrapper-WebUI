            ...
            with gr.Tabs(elem_classes=["mcww-page-tabs"]):
                ...
                with gr.Tab("Behavior"):
                    with gr.Group():
                        ...
                        self._components.latexInlineDollar = gr.Checkbox(label="Handle $ signs as inline math formulas in markdown. But it's better to ask AI use \\( \\) instead for inline math")
                with gr.Tab("Layout"):
                    with gr.Group():
