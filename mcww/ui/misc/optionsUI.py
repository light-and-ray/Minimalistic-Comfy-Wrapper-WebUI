            ...
            with gr.Tabs(elem_classes=["mcww-page-tabs"]):
                ...
                with gr.Tab("Behavior"):
                    with gr.Group():
                        ...
                        self._components.protectUrlsInMarkdownOutput = gr.Checkbox(label="Don't open links on click generated by AI in markdown output components (copy to clipboard instead)")
                with gr.Tab("Layout"):
                    with gr.Group():
