...
1. Click "Install" and select the latest version. Don't select "nightly" version if you have normal security level, because if this case you will get an error
